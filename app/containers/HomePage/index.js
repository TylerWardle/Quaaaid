...
export default class HomePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    // all these constants will be abstracted into pure components in the future
    const GithubIcon = () => (
    ...
    const dummyText = 'this is where you would dump the post text, this is where you would dump the post text, this is where you would dump the post text,';
    const AppBarTest = () => (
      <div>
        <Container>
          <Row>
